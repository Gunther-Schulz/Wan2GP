    ...
    def __torch_function__(cls, func, types, args=(), kwargs=None):
        ...
        if isinstance(t, ScaledFP8WeightTensor):
            ...
            if func_name == "to":
                ...
                kw.pop("copy", None)  # we always create a new tensor; flag is redundant
    ...
    def __torch_dispatch__(cls, op, types, args, kwargs=None):
        ...
        if op is torch.ops.aten.detach:
            ...
            return ScaledFP8WeightTensor.create(
                ...
                dtype=t.dtype,
                device=t.device,
                # requires_grad stays hardcoded False (local fp8 inference-tensor
                # fix): the comment above depends on never sharing version
                # counters with inference tensors. force_full_precision_mm is
                # upstream's new constructor parameter and must be carried.
                requires_grad=False,
